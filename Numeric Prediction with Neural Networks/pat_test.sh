...
INFILE="/home/sh2/S3400652/HDrive/DM/Ass2/Part2/heart-v1-test.arff"


###Insert the header of the pat file
### JavaNNS is very very fussy about the header.
/bin/echo "SNNS pattern definition file V3.2"  >heart_test.pat
/bin/echo "generated at Tue Sep 24 12:59:23 2020"  >>heart_test.pat
/bin/echo ""  >>heart_test.pat
/bin/echo "No. of patterns : 119"  >>heart_test.pat
/bin/echo "No. of input units : 23"  >>heart_test.pat
/bin/echo "No. of output units : 1"  >>heart_test.pat
/bin/echo ""  >>heart_test.pat
