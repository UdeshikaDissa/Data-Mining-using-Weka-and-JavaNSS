...
INFILE="/home/sh2/S3400652/HDrive/DM/Ass2/hypothyroid_test.arff"


###Insert the header of the pat file
### JavaNNS is very very fussy about the header.
/bin/echo "SNNS pattern definition file V3.2"  >hypothyroid_test.pat
/bin/echo "generated at Tue Sep 24 12:59:23 2020"  >>hypothyroid_test.pat
/bin/echo ""  >>hypothyroid_test.pat
/bin/echo "No. of patterns : 725"  >>hypothyroid_test.pat
/bin/echo "No. of input units : 34"  >>hypothyroid_test.pat
/bin/echo "No. of output units : 4"  >>hypothyroid_test.pat
/bin/echo ""  >>hypothyroid_test.pat
